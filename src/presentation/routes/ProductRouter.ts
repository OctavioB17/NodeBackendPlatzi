...
router.patch('/update/stock/:id', validatorHandler(getProductSchema, 'params'), validatorHandler(updateStockSchema, 'body'), (req, res, next) => productController.updateStockController(req, res, next))
